...
class MITMProxy:
    ...
    @timeout(30, exception_message='Mitmdump failed to start after 30 seconds', use_signals=False)
    def wait_until_proxy_is_listening(self):
        """
        Checks if the mitmdump service is listening, and raises an exception if 5 seconds pass without positive answer
        """
